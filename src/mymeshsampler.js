...
///////////////////////////////////////////////////////////////////////////
// Changed to add condition to sampling to avoid small triangles 
// Copying the whole class was necessary as all these functions are defined and called in the constructor
// My changes are on lines 70-78
// TODO: Add check to avoid edges (transform to relative to face, then see if extends past)
///////////////////////////////////////////////////////////////////////////
  ...
  MeshSurfaceSampler.prototype = {
    ...
    build: function () {
      ...
      for (let i = 0; i < positionAttribute.count; i += 3) {
        ...
        // MODIFIED CODE START
        const area = _face.getArea();
        faceWeight *= area;
        if (area < 3.0
            || _face.a.distanceToSquared(_face.b) < 1.0
            || _face.b.distanceToSquared(_face.c) < 1.0
            || _face.c.distanceToSquared(_face.a) < 1.0
            ) faceWeight = 0.0;
        // MODIFIED CODE END
